...
def analyze(handle):
    ...
    statuses = twitter_api.GetUserTimeline(screen_name=handle, count=2, include_rts=False)
    text = ""
    ...
    for s in statuses:
        if s.lang == 'en':
            print(s.text)
            text += s.text
    pi_username = 'd0be89bf-976e-4c97-a422-1f87a7ab218f'
    pi_password = 'U6TYTrJtJLEe'
